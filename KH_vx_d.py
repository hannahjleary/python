...
dnamein = '../../../data/KH/KH_d/d_2_1/'

vx_d_2_1 = np.empty(iend)
...
dnamein = '../../../data/KH/KH_d/d_1.5_1/'

vx_d_15_1 = np.empty(iend)
...
with plt.style.context("ggplot"):
    plt.plot(times, vx_d_3_1, label="d1 = 3.0, d2 = 1.0")
    plt.plot(times, vx_d_2_1, label="d1 = 2.0, d2 = 1.0")
    plt.plot(times, vx_d_15_1, label="d1 = 1.5, d2 = 1.0")
    ...
    # save the figure
    plt.savefig(dnameout + 'kh_vx_d'+ '.png', dpi=300, transparent=False)
    plt.close()